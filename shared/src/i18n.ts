...
const dict = {
  en: {
    ...
    vscodeHowCollect: "Collect 32 items to complete your collection",
    ...
    // ── VSCode Explore ──
    vscodeTabFarm: "Farm",
    vscodeTabExplore: "Explore",
    vscodeExploreTitle: "Explore",
    vscodeMyNeighbors: "Neighbors (Bookmarks)",
    vscodeNoNeighbors: "No neighbors yet.\nDiscover farms with Random Visit!",
    vscodeRandomVisit: "Random Farm Visit",
    vscodeSearching: "Searching...",
    vscodeDiscoveredFarms: "Discovered Farms",
    vscodeSearchPlaceholder: "GitHub ID or nickname",
    vscodeSearchBtn: "Search",
    vscodeSearchResults: "Search Results",
    vscodeSearchNoResults: "No farmers found.",
    vscodeVisitBack: "Back",
    vscodeVisitWater: "Water",
    vscodeVisitWaterRemaining: "/3 left",
    vscodeVisitWaterDone: "No water left today",
    vscodeVisitBookmark: "Bookmark",
    vscodeVisitBookmarked: "Bookmarked",
    vscodeVisitLevel: "Lv.",
  },
  ...
  ko: {
    ...
    vscodeHowCollect: "32종 아이템을 모아 도감을 완성하세요",
    ...
    vscodeTabFarm: "농장",
    vscodeTabExplore: "탐험",
    vscodeExploreTitle: "탐험",
    vscodeMyNeighbors: "내 이웃 (북마크)",
    vscodeNoNeighbors: "아직 이웃이 없어요.\n랜덤 방문으로 농장을 구경해보세요!",
    vscodeRandomVisit: "랜덤 농장 방문",
    vscodeSearching: "찾는 중...",
    vscodeDiscoveredFarms: "발견한 농장",
    vscodeSearchPlaceholder: "GitHub ID 또는 닉네임",
    vscodeSearchBtn: "검색",
    vscodeSearchResults: "검색 결과",
    vscodeSearchNoResults: "농부를 찾지 못했어요.",
    vscodeVisitBack: "돌아가기",
    vscodeVisitWater: "물 주기",
    vscodeVisitWaterRemaining: "/3 남음",
    vscodeVisitWaterDone: "오늘 물 다 줬어요",
    vscodeVisitBookmark: "북마크",
    vscodeVisitBookmarked: "북마크됨",
    vscodeVisitLevel: "Lv.",
  },
} as const;
