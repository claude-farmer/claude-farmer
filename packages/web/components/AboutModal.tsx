...
export default function AboutModal({ onClose }: AboutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-end justify-center" onClick={onClose}>
      <div
        className="bg-[var(--bg)] w-full max-w-md rounded-t-xl max-h-[85vh] overflow-y-auto"
      ...
      >
        ...
        {/* Hero */}
        <section className="text-center px-6 pt-6 pb-4">
          <h1 className="text-2xl font-extrabold tracking-tight mb-2">{t.heroTagline}</h1>
        ...
        {/* Get Started */}
        <section className="px-6 pb-4">
          <h2 className="text-xs font-bold mb-2 opacity-50">{t.getStarted}</h2>
        ...
        <section className="px-6 pb-6">
          <h2 className="text-xs font-bold mb-2 opacity-50">{t.footerPlatforms}</h2>
        ...
        {/* License */}
        <div className="text-center text-xs opacity-30 px-6 pb-4">
          <p>{t.footerLicense}</p>
        </div>
      </div>
    </div>
